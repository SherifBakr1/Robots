...
###############
    ...
    elif state==57 or state ==52 or state ==47 or state == 42 or state == 37  or state == 32 or state ==27 or state ==22 or state ==17 or state ==12 or state ==7 or state ==2:
        reward = 10
    else:
        reward=0
...
def Qlearn():
    ...
    while episode < (MAX_EPISODE/3):
        ...
        steps=0
        while not end and not rospy.is_shutdown() and steps<100:                  # steps 30 straight wall  # were 20 for left  #were 45 u turn
            steps+=1
            print(steps)
        ...
        print("THIS IS THE VALUE OF fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")
        print(f)
        print("THIS IS THE VALUE OF THE TOTAL ACTIONS TAKEN AT STATES 7 and 22")
        print(total_action_taken)
...
def laserscan_callback(msg):
    ...
    #print("THIS IS THE MIN FRONT RIGHT", min_front_right)

    #print("THIS IS THE MIN FRONTTTTTTTTTTTTTTTTTTTTTTTTT", min_front)
    #print("THIS IS THE MIN RIGHTTTTTTTTTTTTTTTTTTTTTTTTTTTT", min_right)
    ...
    #right front states
    if (0.25 < min_front_right < 0.29):
        rightfront = "close"
    elif (0.30 < min_front_right < 0.40):
        rightfront = "medium"
    elif (min_front_right > 0.5):
        rightfront = "far"
